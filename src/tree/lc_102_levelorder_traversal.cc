#include "tree/lc_102_levelorder_traversal.h"

#include "gtest/gtest.h"

namespace algo {
namespace tree {
class LevelorderTraversalTest : public ::testing::Test {
 protected:
  void SetUp() override { exec = new LevelorderTraversal(); }

  void TearDown() override { delete exec; }

 protected:
  LevelorderTraversal* exec{nullptr};
};

TEST_F(LevelorderTraversalTest, levelorderTraversal) {
  ...
  ASSERT_EQ(1, res1.at(0).at(0));
  ASSERT_EQ(2, res1.at(1).at(0));
  ASSERT_EQ(3, res1.at(2).at(0));
  ...
  ASSERT_EQ(3, res4.at(0).at(0));
  ASSERT_EQ(9, res4.at(1).at(0));
  ASSERT_EQ(15, res4.at(2).at(0));
